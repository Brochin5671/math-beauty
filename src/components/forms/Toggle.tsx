...
const toggleVariants = cva(
  "group/toggle inline-flex items-center justify-center gap-1 rounded-md text-sm font-medium whitespace-nowrap transition-[color,box-shadow] outline-none hover:bg-muted hover:text-foreground in-data-[state=hover]:bg-muted in-data-[state=hover]:text-foreground focus-visible:border-ring in-data-[state=focus]:border-ring focus-visible:ring-[3px] in-data-[state=focus]:ring-[3px] focus-visible:ring-ring/50 in-data-[state=focus]:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 aria-pressed:bg-muted dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
