...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center px-4 py-2 text-sm font-medium transition-[color,background-color,border-color,box-shadow,opacity] outline-none focus-visible:ring-3 in-data-[state=focus]:ring-3 focus-visible:ring-ring/50 in-data-[state=focus]:ring-ring/50 focus-visible:focus-outline in-data-[state=focus]:focus-outline disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
...
const navigationMenuLinkStyle = cva(
  "flex items-center gap-1.5 p-2 text-sm transition-[color,background-color,border-color,box-shadow,opacity] outline-none focus-visible:ring-3 in-data-[state=focus]:ring-3 focus-visible:ring-ring/50 in-data-[state=focus]:ring-ring/50 focus-visible:focus-outline in-data-[state=focus]:focus-outline in-data-[slot=navigation-menu-content]:rounded-sm [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
